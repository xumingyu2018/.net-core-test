...
namespace MvcDemo_EF.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserName,Pwd")] UserInfo user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserName,Pwd")] UserInfo user)
        {
            if (id != user.Id)
            {
                return NotFound();
